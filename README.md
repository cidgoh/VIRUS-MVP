...
Viral lineages and variants continue to pose a significant risk to global public health.
...
**Nextflow** and **Docker** for file uploads as file uploads trigger the [nf-ncov-voc][nf-ncov-voc] workflow written in Nextflow.
